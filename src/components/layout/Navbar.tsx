        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-3 group shrink-0">
              <div className="w-10 h-10 bg-brand-orange rounded-full flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300 shrink-0">
                <span className="text-white font-display font-black text-base leading-none">P</span>
              </div>
              <span className="font-display font-black text-2xl tracking-tight text-brand-orange">
                POLLICY
              </span>
            </Link>

            {/* Desktop Nav — sweep animation */}
